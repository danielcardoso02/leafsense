...
A interface gráfica do LeafSense é desenvolvida em Qt5 e fornece visualização em tempo real dos dados do sistema, controlo manual e configurações.
