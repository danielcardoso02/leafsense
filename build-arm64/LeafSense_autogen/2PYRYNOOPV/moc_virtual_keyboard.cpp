/****************************************************************************
** Meta object code from reading C++ file 'virtual_keyboard.h'
**
...
#include <memory>
#include "../../../include/application/gui/virtual_keyboard.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'virtual_keyboard.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(4, 32, 12), // "enterPressed"
QT_MOC_LITERAL(5, 45, 6), // "closed"
QT_MOC_LITERAL(6, 52, 12) // "onKeyClicked"

    },
    "VirtualKeyboard\0keyPressed\0\0key\0"
    "enterPressed\0closed\0onKeyClicked"
};
...
void VirtualKeyboard::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->onKeyClicked((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&VirtualKeyboard::keyPressed)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&VirtualKeyboard::enterPressed)) {
                *result = 1;
                return;
            }
        }
